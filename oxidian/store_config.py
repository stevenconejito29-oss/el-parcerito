...
BRAND_COLOR_DEFAULTS = {
    "COLOR_PRIMARIO": "#F2B705",
    "COLOR_SECUNDARIO": "#D94F3D",
    "COLOR_ACENTO": "#147A55",
}


PUBLIC_THEME_DEFAULTS = {
    "COLOR_FONDO_APP": "#FFF8DE",
    "COLOR_SUPERFICIE": "#FFFFFF",
    "COLOR_SUPERFICIE_ALT": "#FFEAA2",
    "COLOR_TEXTO": "#241C12",
    "COLOR_TEXTO_SUAVE": "#6F6252",
    "COLOR_CABECERA_FONDO": "#173A4A",
    "COLOR_CABECERA_TEXTO": "#FFFDF6",
    "COLOR_EXITO": "#267A52",
    "COLOR_ALERTA": "#B83D3A",
    "COLOR_INFORMATIVO": "#276C8A",
    "COLOR_ADVERTENCIA": "#A86500",
    "COLOR_PROMOCION": "#D95F32",
    "COLOR_DESTACADO": "#6F8F35",
}
