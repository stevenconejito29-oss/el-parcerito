...
LOCKED_CONFIG_KEYS = frozenset({
    ...
    "BOT_REPORT_RATE_WINDOW_SEC", "BOT_REPORT_RATE_MAX",
    "BOT_HANDOFF_SLA_WARNING_SEC", "BOT_HANDOFF_OWNER_ALERT_THRESHOLD",
    "BOT_HANDOFF_OWNER_ALERT_COOLDOWN_SEC", "BOT_HANDOFF_QUEUE_MAX_SEC",
