...
PUBLIC_THEME_DEFAULTS = {
    "COLOR_FONDO_APP": "#FBF7EC",
    "COLOR_SUPERFICIE": "#FFFFFF",
    "COLOR_SUPERFICIE_ALT": "#F4E8C5",
    "COLOR_TEXTO": "#1F2933",
    "COLOR_TEXTO_SUAVE": "#66717B",
    "COLOR_CABECERA_FONDO": "#263A47",
    "COLOR_CABECERA_TEXTO": "#FFFFFF",
    "COLOR_EXITO": "#3D7A57",
    "COLOR_ALERTA": "#B5443E",
    "COLOR_INFORMATIVO": "#315F7D",
    "COLOR_ADVERTENCIA": "#A96C16",
    "COLOR_PROMOCION": "#C16D3F",
    "COLOR_DESTACADO": "#7A8341",
}
...
STORE_DEFAULTS = {
    ...
    "APP_ICON_URL": "",
    "HERO_IMAGE_URL": "",
    "COLOR_PRIMARIO": "#DDAF2B",
    "COLOR_SECUNDARIO": "#B85C38",
    "COLOR_ACENTO": "#315F7D",
