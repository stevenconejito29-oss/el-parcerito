...
PUBLIC_UI_FIELDS = [
    ...
    ("UI_HEADER_CART_ACTION", "Acción de la canasta"),
    ("UI_HEADER_STAFF", "Acceso de empleados"),
    ("UI_HEADER_ORIGIN", "Cabecera · sello de origen"),
    ...
    ("UI_HERO_SIGNATURE", "Portada · firma de origen"),
    ("UI_MENU_CATALOG_TITLE", "Menú · título del catálogo"),
    ("UI_MENU_CATALOG_SUBTITLE", "Menú · subtítulo del catálogo"),
    ("UI_CART_EYEBROW", "Canasta · antetítulo"),
    ("UI_CART_NAME", "Canasta · nombre común"),
    ("UI_CART_TITLE", "Canasta · título"),
    ("UI_CART_ITEM_ONE", "Canasta · producto singular"),
    ("UI_CART_ITEM_MANY", "Canasta · productos plural"),
    ("UI_CART_BACK", "Canasta · volver"),
    ("UI_CART_PROCESS", "Canasta · nombre del proceso"),
    ("UI_CART_STEP_CART", "Paso canasta"),
    ...
    ("UI_CART_EMPTY_TITLE", "Canasta vacía · título"),
    ...
    ("UI_CART_REVIEW_TITLE", "Canasta · aviso de revisión"),
    ("UI_CHECKOUT_EYEBROW", "Confirmación · antetítulo"),
    ("UI_CHECKOUT_TITLE", "Confirmación · título"),
    ("UI_CHECKOUT_SUBTITLE", "Confirmación · mensaje"),
    ("UI_CHECKOUT_SUMMARY", "Confirmación · título del resumen"),
    ("UI_CHECKOUT_MEMORY", "Confirmación · mensaje emocional"),
    ("UI_ORDER_SUCCESS_EYEBROW", "Pedido confirmado · antetítulo"),
    ("UI_ORDER_SUCCESS_TITLE", "Pedido confirmado · título"),
    ("UI_ORDER_SUCCESS_TEXT", "Pedido confirmado · mensaje"),
    ("UI_ORDER_NUMBER_HELP", "Pedido confirmado · ayuda del número"),
    ...
    ("UI_NAV_CART", "Navegación · canasta"),
]
...
def config():
    ...
    public_ui_groups = [
        ...
        ("Canasta", [(key, label) for key, label in PUBLIC_UI_FIELDS if key.startswith("UI_CART_")]),
        ("Confirmación y cierre", [
            (key, label) for key, label in PUBLIC_UI_FIELDS
            if key.startswith("UI_CHECKOUT_") or key.startswith("UI_ORDER_SUCCESS_") or key == "UI_ORDER_NUMBER_HELP"
        ]),
