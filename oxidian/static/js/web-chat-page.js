(() => {
  ...
  function renderOrders(rows = []) {
    ...
    rows.forEach(row => {
      ...
      // Cancelación deliberadamente EXCLUIDA del chat: para evitar
      // clics accidentales, el cliente solo puede cancelar desde el
      // ticket digital (/pedido/<id>/confirmado) con confirmación
      // explícita. El chat solo enseña estado y "Repetir compra".
      if (row.reorderable) {
