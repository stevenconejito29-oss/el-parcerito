...
test('la apertura del control de tienda exige PIN antes de una mutación', async () => {
  ...
  assert.match(sent.detalle, /PIN/i);
});
...
test('una confirmación pendiente no se ejecuta sin desbloquear el PIN', async () => {
